...
The remaining palette formulas output artistic palettes and contain a similar structure with
=StandardPalette= being the most basic.
...
**** Artistic Palette Setup

=generateArtisticPalette= does the heavy lifting to create tints, tones, and shades.
