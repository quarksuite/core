// [[file:../../../README.org::*Color Adjustment (=src/color/adjust/index.js=)][Color Adjustment (=src/color/adjust/index.js=):2]]
...
export const preserve = (target, color) =>
  Object.values({
    ...
    .toString();
// Color Adjustment (=src/color/adjust/index.js=):2 ends here
