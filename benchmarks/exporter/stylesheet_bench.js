...
Deno.bench({ warmup, n }, function stylesheetCssExporterStress() {
  return stylesheet("css", dict);
});

Deno.bench({ warmup, n }, function stylesheetScssExporterStress() {
  return stylesheet("scss", dict);
});

Deno.bench({ warmup, n }, function stylesheetLessExporterStress() {
  return stylesheet("less", dict);
});

Deno.bench({ warmup, n }, function stylesheetStylExporterStress() {
