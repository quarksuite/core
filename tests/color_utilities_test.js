...
const testColorAdjustment = [
  ...
  [
    ...
    string(color_adjust({ lightness: -60 }, color), "#0f003a"),
    string(color_adjust({ lightness: -80 }, color), "#07002a"),
    string(color_adjust({ lightness: 20 }, color), "#6ad2ff"),
    string(color_adjust({ lightness: 40 }, color), "#9cffff"),
    string(color_adjust({ lightness: 60 }, color), "#9cffff"),
    string(color_adjust({ lightness: 80 }, color), "#9cffff"),
  ],
  [
    "adjusting chroma",
    string(color_adjust({ chroma: -20 }, color), "#4b92e3"),
    string(color_adjust({ chroma: -40 }, color), "#6893c6"),
    string(color_adjust({ chroma: -60 }, color), "#7f92a8"),
    string(color_adjust({ chroma: -80 }, color), "#909090"),
    string(color_adjust({ chroma: 20 }, color), "#008cff"),
    string(color_adjust({ chroma: 40 }, color), "#0085ff"),
    string(color_adjust({ chroma: 60 }, color), "#007bff"),
    string(color_adjust({ chroma: 80 }, color), "#006dff"),
  ],
  [
    "adjusting hue",
...
const testColorMixture = [
  ...
  [
    ...
    string(color_mix({ amount: 10 }, color), "#197cde"),
...
const testColorInterpolation = [
  ...
  [
    "interpolate lightness (black <-> white)",
    data(color_interpolation({ lightness: 60 }, "black"), [
      "#010101",
      "#060606",
      "#121212",
      "#1f1f1f",
    ...
    data(color_interpolation({ lightness: 80 }, "black"), [
      "#020202",
      "#0d0d0d",
      "#1f1f1f",
      "#333333",
    ...
    data(color_interpolation({ lightness: 100 }, "black"), [
      "#030303",
      "#161616",
      "#2e2e2e",
      "#484848",
    ...
    data(color_interpolation({ lightness: -60 }, "white"), [
      "#ebebeb",
      "#d7d7d7",
      "#c4c4c4",
      "#b1b1b1",
    ...
    data(color_interpolation({ lightness: -80 }, "white"), [
      "#e4e4e4",
      "#cacaca",
      "#b1b1b1",
      "#989898",
    ...
    data(color_interpolation({ lightness: -100 }, "white"), [
      "#dedede",
      "#bdbebe",
      "#9e9e9e",
      "#808080",
  ...
  [
    "interpolate chroma (achromaticity)",
    data(color_interpolation({ chroma: 60 }, "gray"), [
      "#848076",
      "#87806c",
      "#8b7f62",
      "#8e7f56",
    ...
    data(color_interpolation({ chroma: 80 }, "gray"), [
      "#858073",
      "#898065",
      "#8e7f56",
      "#937e45",
    ...
    data(color_interpolation({ chroma: 100 }, "gray"), [
      "#868070",
      "#8c7f5e",
      "#927e4a",
      "#977d30",
  ...
  [
    "interpolate chroma(black, white)",
    data(color_interpolation({ chroma: 60 }, "black"), [
      "#000000",
      "#010000",
      "#020000",
      "#030000",
    ]),
    data(color_interpolation({ chroma: 80 }, "black"), [
      "#000000",
      "#010000",
      "#020000",
      "#030000",
    ...
    data(color_interpolation({ chroma: 100 }, "black"), [
      "#000000",
      "#010000",
      "#020000",
      "#030000",
    ...
    data(color_interpolation({ chroma: 60 }, "white"), [
      "#fffff4",
      "#ffffe9",
      "#ffffdd",
      "#fffed1",
    ...
    data(color_interpolation({ chroma: 80 }, "white"), [
      "#fffff0",
      "#ffffe1",
      "#fffed1",
      "#fffec1",
    ...
    data(color_interpolation({ chroma: 100 }, "white"), [
      "#ffffed",
      "#fffed9",
      "#fffec5",
      "#fffdb0",
...
const testPaletteFilter = [
  ...
  [
    ...
    data(
      palette_filter(
        { property: "chroma", min: 45 },
        color_interpolation({ chroma: 100 }, color),
      ),
      ["#006dff", "#0063ff", "#0057ff"],
    ),
    data(
      palette_filter(
        { property: "chroma", min: 45, max: 50 },
        color_interpolation({ chroma: 100 }, color),
      ),
      ["#006dff", "#0063ff"],
    ),
