...
formats. This section documents how the QSC validates colors and extracts values for calculation space.
...
its unique and repeating parts and then assembled with the =RegExp.source= property as a new =RegExp= object.
