...
+ [[https://jsdelivr.com][JSDelivr]]: =https://cdn.jsdelivr.net/gh/quarksuite/core@2.0.1/[module]=
+ [[https://statically.io][Statically]]: =https://cdn.statically.io/gh/quarksuite/core/2.0.1/[module]=
+ [[https://nest.land][Nest.land]]: =https://x.nest.land/quarksuite:core@2.0.1/[module]=
+ [[https://nodejs.org/][Node]] (NPM): =@quarksuite-two/core@2.0.1=
...
const {
  ...
  exporter,
  workflow
} = await import("https://cdn.jsdelivr.net/gh/quarksuite/core@2.0.1/mod.js");
#+END_SRC
...
import {
  ...
  exporter,
  workflow
} from "https://cdn.jsdelivr.net/gh/quarksuite/core@2.0.1/mod.js";
#+END_SRC
...
#+BEGIN_SRC shell
npm install @quarksuite-two/core@2.0.1

# OR

yarn add @quarksuite-two/core@2.0.1
#+END_SRC
...
#+BEGIN_SRC shell
curl -o [module] https://cdn.jsdelivr.net/gh/quarksuite/core@2.0.1/[module]

# OR

wget https://cdn.jsdelivr.net/gh/quarksuite/core@2.0.1/[module]
#+END_SRC
