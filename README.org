...
- [[#internals][Internals]]
  ...
  - [[#color][Color]]
    ...
    - [[#conversion-srcinternalscolorconvertindexjs][Conversion (=src/internals/color/convert/index.js=)]]
      ...
      - [[#functional-cielab-conversion-srcinternalscolorconvertlabjs][Functional CIELAB Conversion (=src/internals/color/convert/lab.js=)]]
      - [[#functional-lch-conversion-srcinternalscolorconvertlchjs][Functional LCH Conversion (=src/internals/color/convert/lch.js=)]]
- [[#data][Data]]
  - [[#color-1][Color]]
...
+ =Functional RGB -> Functional CIELAB=: a progressive conversion to Lab
...
**** Functional CIELAB Conversion (=src/internals/color/convert/lab.js=)
**** Functional LCH Conversion (=src/internals/color/convert/lch.js=)
