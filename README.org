...
- [[#internals][Internals]]
  ...
  - [[#color][Color]]
    - [[#css-formats-srcinternalscolorformatindexjs][CSS Formats (=src/internals/color/format/index.js=)]]
...
** Color
*** CSS Formats (=src/internals/color/format/index.js=)
