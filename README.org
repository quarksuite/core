...
console.log("const colors =", colors.map((color) => ({ color, value: hex.expander(color) })))
#+END_SRC
...
const colors = [
  ...
  { color: "#808080", value: "#808080" },
  { color: "#ffffff", value: "#ffffff" },
  { color: "#ff0000", value: "#ff0000" },
  { color: "#ffff00", value: "#ffff00" },
  { color: "#00ff00", value: "#00ff00" },
  { color: "#00ffff", value: "#00ffff" },
  { color: "#0000ff", value: "#0000ff" },
  { color: "#ff00ff", value: "#ff00ff" },
  { color: "#ace", value: "#aaccee" },
  { color: "#bea", value: "#bbeeaa" },
  { color: "#fed", value: "#ffeedd" },
  { color: "#face", value: "#ffaaccee" },
  { color: "#cafe", value: "#ccaaffee" },
  { color: "#deaded", value: "#deaded" },
  { color: "#c0ffee", value: "#c0ffee" },
  { color: "#4991ccaa", value: "#4991ccaa" },
  { color: "#abcdef68", value: "#abcdef68" }
]
#+end_src
...
console.log("const colors =", colors.map(({color, value}) => ({color, values: hex.extract(value)})));
#+END_SRC
...
| Gray    | =lch(53.59% 0 0)=              |
| White   | =lch(100% 0 0)=                |
| Red     | =lch(54.29% 107 41)=           |
| Yellow  | =lch(97.6% 95 100)=            |
| Green   | =lch(87.82% 113 134)=          |
| Cyan    | =lch(90.67% 53 196)=           |
| Blue    | =lch(29.57% 131 301)=          |
| Magenta | =lch(60.17% 111 327)=          |
| Etc.    | =lch(53.31% 89 200)=           |
|         | =lch(89.1% 167 3.6rad / 0.99)= |
|         | =lch(24.494% 74 193grad)=      |
|         | =lch(47.39% 111 0.62turn / 75%)= |
...
const colors = [
  ...
  { color: "lch(54.29% 107 41)", values: [ "54.29%", "107", "41" ] },
  { color: "lch(97.6% 95 100)", values: [ "97.6%", "95", "100" ] },
  { color: "lch(87.82% 113 134)", values: [ "87.82%", "113", "134" ] },
  { color: "lch(90.67% 53 196)", values: [ "90.67%", "53", "196" ] },
  { color: "lch(29.57% 131 301)", values: [ "29.57%", "131", "301" ] },
  { color: "lch(60.17% 111 327)", values: [ "60.17%", "111", "327" ] },
  { color: "lch(53.31% 89 200)", values: [ "53.31%", "89", "200" ] },
  {
    color: "lch(89.1% 167 3.6rad / 0.99)",
    values: [ "89.1%", "167", "3.6rad", "0.99" ]
  },
  { color: "lch(24.494% 74 193grad)", values: [ "24.494%", "74", "193grad" ] },
  {
    color: "lch(47.39% 111 0.62turn / 75%)",
    values: [ "47.39%", "111", "0.62turn", "75%" ]
  }
]
#+end_src
...
[
  ...
  { rgb: "rgb(128, 128, 128)", cmyk: "device-cmyk(0% 0% 0% 49.8039%)" },
  ...
  { rgb: "rgb(33, 199, 95)", cmyk: "device-cmyk(83.4171% 0% 52.2613% 21.9608%)" },
  { rgb: "rgb(19, 114, 220)", cmyk: "device-cmyk(91.3636% 48.1818% 0% 13.7255%)" },
  {
    rgb: "rgb(10%, 40.4%, 49.9%)",
    cmyk: "device-cmyk(79.5275% 18.8975% 0% 50.1961%)"
  },
  { rgb: "rgb(200 138 39)", cmyk: "device-cmyk(0% 31.0001% 80.5% 21.5686%)" },
  {
    rgb: "rgb(31 88 49 / 0.8)",
    cmyk: "device-cmyk(64.7726% 0% 44.3181% 65.4902% / 0.8)"
  },
  { rgb: "rgba(110, 33, 110, 0.75)", cmyk: "device-cmyk(0% 70% 0% 56.8627% / 0.75)" },
  {
    rgb: "rgba(10, 119, 30, 30%)",
    cmyk: "device-cmyk(91.5966% 0% 74.7899% 53.3333% / 0.3)"
  }
]
#+end_src
...
[
  ...
  { lab: "lab(54.29% 80.81 69.89)", lch: "lch(54.29% 107 41)" },
  { lab: "lab(97.6% -15.75 93.39)", lch: "lch(97.6% 95 100)" },
  { lab: "lab(87.82% -79.29 80.99)", lch: "lch(87.82% 113 134)" },
  { lab: "lab(90.67% -50.67 -14.96)", lch: "lch(90.67% 53 196)" },
  { lab: "lab(29.57% 68.3 -112.03)", lch: "lch(29.57% 131 301)" },
  { lab: "lab(60.17% 93.55 -60.5)", lch: "lch(60.17% 111 327)" },
  { lab: "lab(49.18% 38.1 -110.33)", lch: "lch(49.18% 117 289)" },
  { lab: "lab(91.3% -93 14)", lch: "lch(91.3% 94 171)" },
  { lab: "lab(83.119% 49.34 -3.99 / 0.75)", lch: "lch(83.119% 50 0 / 0.75)" },
  { lab: "lab(199% 38 13 / 78%)", lch: "lch(199% 40 0 / 0.78)" }
]
#+end_src
...
[
  ...
  { lch: "lch(54.29% 107 41)", lab: "lab(54.29% 81 70)" },
  { lch: "lch(97.6% 95 100)", lab: "lab(97.6% -16 94)" },
  { lch: "lch(87.82% 113 134)", lab: "lab(87.82% -78 81)" },
  { lch: "lch(90.67% 53 196)", lab: "lab(90.67% -51 -15)" },
  { lch: "lch(29.57% 131 301)", lab: "lab(29.57% 67 -112)" },
  { lch: "lch(60.17% 111 327)", lab: "lab(60.17% 93 -60)" },
  { lch: "lch(53.31% 89 200)", lab: "lab(53.31% -84 -30)" },
  { lch: "lch(89.1% 167 3.6rad / 0.99)", lab: "lab(89.1% -128 -73 / 0.99)" },
  { lch: "lch(24.494% 74 193grad)", lab: "lab(24.494% -74 8)" },
  { lch: "lch(47.39% 111 0.62turn / 75%)", lab: "lab(47.39% -81 -76 / 0.75)" }
]
#+end_src
