...
color is /adjustment/. QuarkSuite prioritizes the perceptual uniformity of all color adjustments and so adjusts colors
through the OKLab color space as OKLCH.
